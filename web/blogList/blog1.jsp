    ...
    <body>
        <div>
            ...
            <p>
                ...
                chúng tôi sẽ hướng dẫn bạn một số mẹo nhỏ để chọn được thịt bò mềm, tươi ngon, làm steak chuẩn âu cho món ăn tròn vị đạm chất phương tây.
                Cách chọn thịt bò đông lạnh
                Thịt bò ngon có màu đỏ tươi, mỡ màu trắng nhiều vân mỡ trắng xen kể với nhau nhiều ,nếu ít mỡ trắng dễ cưng và khô miếng thịt .làm steak nên dùng topblade, 
                ribeye, tenderloin, Tbone để cho món steak của bạn tròn vị .
            </p>
        </div>
    </body>
</html>
